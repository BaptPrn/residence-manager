...
ActiveRecord::Schema.define(version: 2019_03_26_162407) do
  ...
  create_table "payments", force: :cascade do |t|
    ...
    t.index ["related_payment_id"], name: "index_payments_on_related_payment_id"
  ...
  add_foreign_key "discounts", "stays"
